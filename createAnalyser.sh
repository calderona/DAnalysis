...
sed -e 's;ANALYSER_TEMPL;'${ananame}';g' < $src/ANALYSER_TEMPL.h > /afs/cern.ch/user/c/cprieels/DAnalysis/interface/${ananame}.h
sed -e 's;ANALYSER_TEMPL;'${ananame}';g' < $src/ANALYSER_TEMPL.cpp > /afs/cern.ch/user/c/cprieels/DAnalysis/src/${ananame}.cpp
sed -e 's;ANALYSER_TEMPL;'${ananame}';g' < $src/ANALYSER_TEMPL_EXEC.cpp > /afs/cern.ch/user/c/cprieels/DAnalysis/bin/${ananame}.cpp
